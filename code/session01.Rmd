...
We now turn to a more fine-grained version of the data set provided by AidData which, besides the sole number of projects or the amount of aid, contains quite some interesting additional information such as the recipient, the recipient region, the intent or the targeted sector.
